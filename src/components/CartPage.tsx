...
const BRANDS = [
  {
    name: "BOSCH",
    prefix: (
      <div className="w-8 h-8 rounded-full border-2 border-slate-500 flex items-center justify-center mr-2">
        <div className="w-4 h-5 border-x-2 border-slate-500 rounded-sm"></div>
      </div>
    ),
    color: "text-[#e22739]",
    weight:
  ...
  },
  {
    name: "SATA",
    prefix: (
      <div className="w-8 h-8 mr-2 flex flex-col justify-center items-center text-[#296a4b]">
  ...
  },
  {
    name: "PISCO",
    color: "text-[#28479e]",
    weight: "font-black text-2xl sm:text-3xl tracking-wider",
  },
  {
    name: "CDC",
    suffix: (
      <div className="ml-2 text-[8px] sm:text-[10px] text-black font-sans leading-none flex flex-col justify-center font-bold tracking-normal mt-1 text-left">
        <span>씨디씨뉴매틱</span>
  ...
  {
    name: "SELLEYS",
    color: "text-white bg-[#273a8a] px-2 py-0.5 sm:px-3 sm:py-1",
    weight: "font-black text-xl sm:text-[22px] italic tracking-wider",
  },
  {
    name: "KST",
    color: "text-[#c63d35]",
    weight: "font-black text-2xl sm:text-3xl",
  },
  {
    name: "NACHI",
    color: "text-[#df3634]",
    weight: "font-medium text-2xl sm:text-3xl tracking-widest",
  },
  {
    name: "SKF",
    color: "text-[#0d4f9b]",
    weight: "font-black text-2xl sm:text-3xl tracking-tighter",
  },
];
...
export default function CartPage({
    ...
    <>
      <div className="bg-[#f2f2f2] w-full py-12 px-6 lg:px-12 flex justify-center flex-1">
        <div className="w-full max-w-[1400px]">
          <h3 className="text-[27px] font-bold text-[#1a1a1a] mb-6 tracking-tight">
            Shop Categories
          </h3>
          <div className={`relative ${isExpanded ? "mb-12" : ""}`}>
            ...
            {!isExpanded && (
              <div className="absolute bottom-0 left-0 right-0 h-[120px] bg-linear-to-t from-[#f2f2f2] via-[#f2f2f2]/80 to-transparent pointer-events-none" />
            )}
            <div
              className={`absolute ${isExpanded ? "-bottom-12" : "-bottom-6"} left-0 right-0 flex justify-center`}
            >
              <button
      ...
      <div className="bg-white w-full py-[15px] px-6 lg:px-12 flex justify-center border-t border-slate-100">
        <div className="w-full max-w-[1400px]">
          <div className="flex items-baseline gap-2 mb-8">
            <h3 className="text-[27px] font-bold text-[#1a1a1a] tracking-tight">
              Brands We Carry
            </h3>
            <span className="text-slate-600 text-[14px] ml-2">
              Thousands of brands!
            </span>
            <a
              href="#"
              className="text-[#2071a7] text-[14px] hover:underline ml-1"
            >
              See more
            </a>
          </div>
        ...
        <div className="w-full max-w-[1400px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            <div className="flex flex-col items-center text-center">
              ...
              <h4 className="font-bold text-[#1a1a1a] mb-2 text-[15px]">
                Hỗ trợ khách hàng tận tâm
              </h4>
              <p className="text-slate-500 text-[13px] leading-relaxed">
                Đội ngũ tư vấn chuyên nghiệp, luôn sẵn sàng hỗ trợ nhanh chóng
                và hiệu quả.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-slate-500 text-[13px] leading-relaxed">
                Cung cấp mức giá cạnh tranh cho các sản phẩm và vật tư bạn sử
                dụng thường xuyên.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-slate-500 text-[13px] leading-relaxed">
                Hỗ trợ giao hàng nhanh trên toàn quốc với nhiều phương thức vận
                chuyển linh hoạt.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-slate-500 text-[13px] leading-relaxed">
                Đơn hàng được xác nhận và xử lý nhanh giúp đảm bảo tiến độ công
                việc của bạn.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
              ...
              <h4 className="font-bold text-[#1a1a1a] mb-2 text-[15px]">
                Hỗ trợ công nợ doanh nghiệp
              </h4>
              <p className="text-slate-500 text-[13px] leading-relaxed">
                Chính sách công nợ linh hoạt dành cho khách hàng và doanh nghiệp
                đủ điều kiện.
              </p>
            </div>
          </div>
      ...
      <div className="bg-white w-full flex justify-center border-t border-slate-100 pb-12">
        <div className="w-full max-w-[1400px]">
          <div
            className={`relative px-6 py-12 lg:px-12 flex flex-col items-start text-left ${isDescriptionExpanded ? "pb-24" : ""}`}
          >
            ...
            <div
              className={`relative overflow-hidden transition-all duration-300 w-full text-slate-600 text-[15px] space-y-4 ${isDescriptionExpanded ? "max-h-[1000px]" : "max-h-[140px]"}`}
            >
              <p>
                Mua sắm tại Mecsu và khám phá hàng ngàn sản phẩm chất lượng từ
                nhiều thương hiệu uy tín trong lĩnh vực cơ khí, công nghiệp và
                xây dựng. Chúng tôi cung cấp đa dạng vật tư và thiết bị như bu
                lông, ốc vít, dụng cụ cầm tay, thiết bị điện, vật tư khí nén,
                thiết bị an toàn lao động và nhiều sản phẩm công nghiệp khác
                giúp doanh nghiệp vận hành hiệu quả hơn mỗi ngày.
              </p>

              <p>
                Mecsu mang đến trải nghiệm mua sắm trực tuyến tiện lợi với thông
                tin sản phẩm rõ ràng, tìm kiếm nhanh chóng, giá cả cạnh tranh và
                nguồn hàng ổn định. Dù bạn là xưởng cơ khí, nhà máy sản xuất,
                đơn vị thi công hay doanh nghiệp thương mại, bạn đều có thể dễ
                dàng tìm thấy sản phẩm phù hợp với nhu cầu sử dụng thực tế.
              </p>

              <p>
                Là đơn vị hoạt động trong lĩnh vực vật tư công nghiệp và MRO
                (Maintenance, Repair & Operations), Mecsu cung cấp các sản phẩm
                và linh kiện phục vụ cho bảo trì, sửa chữa và vận hành hệ thống
                sản xuất. Chúng tôi hỗ trợ từ nhu cầu cơ bản đến chuyên sâu với
                đa dạng danh mục như:
              </p>
              ...
              <p>
                Với danh mục sản phẩm liên tục được mở rộng, Mecsu giúp doanh
                nghiệp dễ dàng tìm đúng sản phẩm cần thiết, tiết kiệm thời gian
                tìm kiếm và đảm bảo tiến độ công việc với dịch vụ hỗ trợ nhanh
                chóng và giao hàng toàn quốc.
              </p>

              {!isDescriptionExpanded && (
                <div className="absolute bottom-0 left-0 right-0 h-[80px] bg-linear-to-t from-white to-transparent pointer-events-none" />
              )}
            </div>

            <div
              className={`absolute ${isDescriptionExpanded ? "bottom-8" : "bottom-2"} left-0 right-0 flex justify-center z-10`}
            >
              <button
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="min-h-[60vh] flex flex-col w-full bg-[#F6F8FB]"
    >
      {items.length === 0 ? (
        <div className="bg-white w-full py-16 px-6 lg:px-12 flex justify-center border-b border-slate-100">
          <div className="w-full max-w-[1400px]">
            ...
            <button
              onClick={onBack}
              className="bg-[#163F78] text-white px-6 py-2.5 rounded font-bold text-[14px] hover:bg-[#122f5f] transition-colors"
            >
              Continue Shopping
            </button>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto px-4 py-8 font-sans w-full bg-[#F6F8FB]">
          <div className="flex items-center justify-between mb-8 pb-6 border-b border-premium-border">
            ...
            <button
              onClick={onBack}
              className="text-text-dim hover:text-text-navy font-semibold underline"
            >
              Tiếp tục mua sắm
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {items.map((item) => (
                ...
                >
                  ...
                  <div className="w-20 h-20 border border-slate-200 rounded-lg p-2 shrink-0 bg-slate-50/50">
                    <OptimizedImage
                      src={
                        getRandomImage(item.product.name) || item.product.image
                      }
            ...
            <div className="bg-white p-6 rounded-lg border border-slate-200/80 sticky top-24">
                <h2 className="text-[15px] font-bold text-[#111111] uppercase tracking-wide mb-5 pb-3 border-b border-slate-100">
                  Tóm tắt đơn hàng
                </h2>
                ...
                <button
                  onClick={onCheckout}
                  className="w-full bg-brand-primary text-text-navy font-bold py-4 rounded text-lg hover:bg-brand-primary/90 flex items-center justify-center gap-2"
                >
                  <Building2 size={20} />
